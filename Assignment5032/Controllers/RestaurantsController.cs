...
namespace Assignment5032.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RestID,Name,Address,ContactNumb")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RestID,Name,Address,ContactNumb")] Restaurant restaurant)
        {
            if (ModelState.IsValid)
            {

...
namespace Assignment5032.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TypeID,EventName,Description")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TypeID,EventName,Description")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
